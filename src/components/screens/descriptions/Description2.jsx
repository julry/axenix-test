...
export const Description2 = () => {
    ...
    const textPart1 = 'Вы прошли мимо лаунж-зоны с настолками, ' +
        'миновали закуток с кофемашиной и печеньками, полюбовались ' +
        'стенами со стильными граффити, увидели корпоративный спортзал и ' +
        'отправились на последний этаж.'
