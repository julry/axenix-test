...
export const questions = [
    {
        id: '0',
        question: 'Выбери своего персонажа',
        answers: [
            {
                id: '1',
                text: 'Алиса, стажер бизнес-аналитик',
                type: {
                    negative: [],
                    positive: []
                },
            ...
            {
                id: '2',
                text: 'Андрей, младший разработчик',
                type: {
                    negative: [],
                    positive: []
                },
            ...
            {
                id: '3',
                text: 'Полина, младший Data Engineer',
                type: {
                    negative: [],
                    positive: []
                },
            ...
            {
                id: '4',
                text: 'Денис, младший 1С аналитик',
                type: {
                    negative: [],
                    positive: []
                },
    ...
    {
        id: '5',
        text: 'Кирилл из HR-команды встретил тебя в холле на 1 этаже. Первым делом вам предстоит заняться подписанием документов. По пути в отдел он рассказал, как будет проходить адаптация, а также добавил тебя в рабочие чатики. Отличное время, чтобы задать Кириллу вопросы о компании',
